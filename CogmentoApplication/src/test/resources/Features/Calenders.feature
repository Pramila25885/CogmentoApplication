Feature: Test Calender Module in Cogmento Application

Scenario: To check the Calender functionality of Cogmento
Given To launch the Browser and Navigate to the URL
When Enter the Emailid and the Password
Then click Login button
Then User is on home page

Scenario: To Check Save functionality in Calender Module
